...
/**
 * This is the model class for table "cargo_packing".
 *
 * The followings are the available columns in table 'cargo_packing':
 ...
 */
class CargoPacking extends Record
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('idcargo_packing, name', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'cargoInfos' => array(self::HAS_MANY, 'CargoInfo', 'idcargo_packing'),
		);
	}
