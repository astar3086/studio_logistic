...
class CompanyType extends Record
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('idcompany_type, name', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'brokersCtypes' => array(self::HAS_MANY, 'BrokersCtype', 'idcompany_type'),
			'companyAttacheds' => array(self::HAS_MANY, 'CompanyAttached', 'idcompany_type'),
			'supornCtypes' => array(self::HAS_MANY, 'SupornCtype', 'idcompany_type'),
		);
	}
