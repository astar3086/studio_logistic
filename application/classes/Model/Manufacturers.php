 ...
 * @property integer $idmanufacturers
 ...
 */
class Manufacturers extends Record
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('idmanufacturers, name, address', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'products' => array(self::HAS_MANY, 'Products', 'idmanufactures'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('idmanufacturers',$this->idmanufacturers);
