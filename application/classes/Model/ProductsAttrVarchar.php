...
/**
 * This is the model class for table "products_attr_varchar".
 *
 * The followings are the available columns in table 'products_attr_varchar':
 ...
 */
class ProductsAttrVarchar extends Record
{
	/**
	 ...
	 * @return ProductsAttrVarchar the static model class
	 */
