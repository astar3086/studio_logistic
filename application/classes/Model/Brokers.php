...
class Brokers extends Record
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('idbrokers, name, contact_detail, email, country_code, region_code, city_code', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'brokersCtypes' => array(self::HAS_MANY, 'BrokersCtype', 'idbrokers'),
		);
	}
