...
/**
 * This is the model class for table "products_attr_decimal".
 *
 * The followings are the available columns in table 'products_attr_decimal':
 ...
 */
class ProductsAttrDecimal extends Record
{
	/**
	 ...
	 * @return ProductsAttrDecimal the static model class
	 */
